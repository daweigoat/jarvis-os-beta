...
Clone repo ini atau download ZIP-nya.
Install semua dependencies:
bash

pip install -r requirements.txt
Pastikan Ollama udah ke-install dan jalan di background (contoh: buka CMD dan ketik ollama run qwen).
Langsung jalanin file utamanya:
bash
